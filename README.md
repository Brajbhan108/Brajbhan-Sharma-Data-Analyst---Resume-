...
### Disclaimer 
This project was developed with the assistance of AI, specifically for summarizing findings and providing guidance on best practices.

## SKILLS
* Data Analysis & Visualization: Power BI, DAX Functions, Advanced Excel, VBA, Matplotlib, Seaborn
* Data Management: MySQL, Alteryx, Pandas, NumPy
* Programming: Python, SQL
* Business Skills: Report Preparation, Workflow Optimization, Stakeholder Communication
* Technical Expertise: Data Wrangling, Cleaning, Modeling, Statistical Analysis
...
## SKILLS
* Analytical Tools: Proficient in Power BI and MySQL,Alteryx, with Strong Excel Skills, Experience with programming in Jupyter notebook and VS Code.  
* Programming Languages: Expertise in SQL, Python and Libraries (NumPy, Pandas, Data Visualization through Plotly, Matplotlib and Seaborne).  
